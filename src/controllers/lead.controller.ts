...
import { INTERNAL_ERROR_MESSAGE, OTP_GENERARED_SUCCESS_MESSAGE, SAVE_SUCCESS_MESSAGE, SUCCESS_STATUS_CODE, VALIDATION_FAILED_MESSAGE } from "../utils/constant.js";
...
const createLead = async (req: Request, res: Response) => {
    try {
        ...
        return res.status(SUCCESS_STATUS_CODE).json({
            success: true,
            message: OTP_GENERARED_SUCCESS_MESSAGE,
